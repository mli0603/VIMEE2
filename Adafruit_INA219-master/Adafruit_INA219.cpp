 ...
 *
 * @mainpage Adafruit Adafruit_INA219 current/power monitor IC
 *
 * @section intro_sec Introduction
 *
 *  Driver for the Adafruit_INA219 current sensor
 *
 *  This is a library for the Adafruit Adafruit_INA219 breakout
